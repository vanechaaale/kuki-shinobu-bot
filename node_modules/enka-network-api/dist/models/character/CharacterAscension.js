...
class CharacterAscension {
    ...
    constructor(data, enka) {
        ...
        this.cost = new UpgradeCost_1.default(json.getAsNumberWithDefault(0, "scoinCost"), json.has("costItems") ? json.get("costItems").mapArray((_, p) => p.getAsJsonObject()) : [], enka);
    ...
    static getById(id, ascension, enka) {
        var _a;
        const json = (_a = enka.cachedAssetsManager.getGenshinCacheData("AvatarPromoteExcelConfigData").findArray((_, p) => p.getAsNumber("avatarPromoteId") === id && p.getAsNumberWithDefault(0, "promoteLevel") === ascension)) === null || _a === void 0 ? void 0 : _a[1];
        if (!json)
            throw new AssetsNotFoundError_1.default("CharacterAscension", `${id}-${ascension}`);
        return new CharacterAscension(json.getAsJsonObject(), enka);
    }
}
exports.default = CharacterAscension;
