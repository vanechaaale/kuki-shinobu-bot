...
class CharacterStats {
    ...
    constructor(data, enka, element) {
        ...
        this.statProperties = Object.values(this).filter(value => value instanceof StatProperty_1.default);
    }
    /**
     * @param id
     * @param defaultValue
    ...
    getStatProperty(id, defaultValue = 0) {
        var _a;
        return new StatProperty_1.default(constants_1.fightProps[id], ((_a = this._data[id]) !== null && _a !== void 0 ? _a : defaultValue), this.enka);
    }
}
